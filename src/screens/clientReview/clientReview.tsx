  ...
  const renderItem = ({item}) => (
    <View
      ...
      style={[
        ...
        {elevation: 3, width: '95%', alignSelf: 'center'},
      ]}>
      <View
        style={{flexDirection: 'row', alignItems: 'center', gap: scale(20)}}>
        <Image
          source={
            item?.get_selected_user?.profile_pic
              ? {uri: item.get_selected_user.profile_pic}
              : images.profile
          }
