import { View, Text, Easing, KeyboardAvoidingView, Platform, ScrollView, TouchableWithoutFeedback, Keyboard, TouchableOpacity } from 'react-native'
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
          <View style={[mainStyles.container, { flex: 1, justifyContent: 'center', alignItems: 'center' }]}>
            ...
            <TouchableOpacity style={{position:'absolute',alignSelf:'flex-end',right:scale(16),top:verticalScale(50)}} onPress={()=>navigation.navigate('BottomNav')} activeOpacity={0.8}>
              <Text style={[mainStyles.fontNunitoMedium,mainStyles.lightTextColor,mainStyles.fontSize12]}>SKIP</Text>
            </TouchableOpacity>
            ...
            <View style={{ width: '90%', position:'absolute',bottom:verticalScale(20)  }}>
              ...
              <PrimaryButton 
                ...
                disabled={!rating}
                onPress={handleAddRatingAndReview} style={undefined}              />
            </View>
