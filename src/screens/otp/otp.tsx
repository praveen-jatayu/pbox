            ...
            <ImageBackground
              ...
              <View style={loginStyles.bottomSection}>
                ...
                <View style={otpStyles.otpLabelContainer}>
                  ...
                  <Pressable
                    onPress={() =>
                      Linking.openURL(`tel:${route.params.mobileNo}`)
                    }>
                    <Text style={otpStyles.phoneNumberText}>
                      +91 {route.params.mobileNo}
                    </Text>
                  </Pressable>
                </View>
                ...
                {/* Error Message */}
                {isVerifiedPressed && errorMessage ? (
                ...
                <SecondaryButton
                  title={
                    resendTimer > 0
                      ? `Resend OTP in ${formatResendTimer()}`
                      : 'RESEND OTP'
                  }
